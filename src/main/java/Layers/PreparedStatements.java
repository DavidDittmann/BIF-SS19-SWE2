...
public class PreparedStatements {
    ...
    public static String prepInsertPicture =    "INSERT INTO PICTURES (FILEPATH,KEYWORDS,FK_PHOTOGRAPHER_ID,FK_EXIF_ID,FK_ITPC_ID) " +
                                                "VALUES (?,?,?,?,?)";

    public static String prepInsertPhotographer =   "INSERT INTO PHOTOGRAPHERS (NAME,LASTNAME,ADDRESS) " +
                                                    "VALUES (?,?,?)";

    public static String prepInsertITPC =   "INSERT INTO ITPC (PICTURE_NAME,PICTURE_EXT) " +
                                            "VALUES (?,?)";
    ...
    public static String updateKeywordsByID = "UPDATE PICTURES SET KEYWORDS=? WHERE ID=?";
    ...
    public static String prepUpdateITPC =   "UPDATE ITPC SET PICTURE_NAME=?, PICTURE_EXT=?, WHERE ID=?";

    public static String prepSelectAllPictures = "Select ID, FILEPATH, KEYWORDS, FK_PHOTOGRAPHER_ID, FK_EXIF_ID, FK_ITPC_ID FROM PICTURES";
    ...
    public static String prepSelectITPCByID = "Select ID,PICTURE_NAME,PICTURE_EXT FROM ITPC WHERE ID=?";
